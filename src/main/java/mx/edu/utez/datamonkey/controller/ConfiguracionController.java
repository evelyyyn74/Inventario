...
public class ConfiguracionController {
    ...
    public void initialize() {
        comboUnidad.getItems().addAll("Piezas", "Kilogramos", "Litros");
        ...
        if (configuracionActual != null) {
            ...
            if (configuracionActual.getUnidadPorDefecto() != null) {
                comboUnidad.getSelectionModel()
                        .select(configuracionActual.getUnidadPorDefecto());
            }
        } else {
    ...
    private void guardarCambios() {
        ...
        String unidad = comboUnidad.getSelectionModel().getSelectedItem();

        if (nombre.isEmpty() || direccion.isEmpty() || telefono.isEmpty()
                || stockTxt.isEmpty() || unidad == null) {
        ...
        configuracionActual.setUnidadPorDefecto(unidad);
